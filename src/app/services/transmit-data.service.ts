...
export class TransmitDataService {
  ...
  private _correctData  : BehaviorSubject<DataUserOperation[]> = new BehaviorSubject<DataUserOperation[]>([]);
  public dataObject$ : Observable <DataUserOperation[]  > = this._correctData.asObservable();
